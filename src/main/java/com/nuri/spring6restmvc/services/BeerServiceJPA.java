...
public class BeerServiceJPA implements BeerService {
    ...
    @Override
    public Optional<BeerDTO> updateBeerById(UUID beerId, BeerDTO beer) { // ifPresent is pretty nifty
...
//                .collect(Collectors.toList());
    ...
    public PageRequest buildPageRequest(Integer pageNumber, Integer pageSize) {
        ...
        } else { // it's a good defense mechanism not to let page size get out of control
